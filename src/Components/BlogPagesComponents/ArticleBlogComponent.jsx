...
const articles = {
    'panenka': { 'title': 'Panenka', 'date': '15/03/2021', 'categories': ['front', 'back', 'data', 'ops'], 'presentation': <p className="text-justify" style={{ "paddingTop": "3%" }}>Création et développement d'une plateforme serverless en ligne pour faire des pronostiques entre amis à l'occasion de l'EURO2020.</p>, 'technos': ['Python 3', 'Chalice', 'ReactJS', 'AWS', 'Serverless', 'DynamoDB', 'Gitlab'], 'addButon': false, 'addressources': true, 'ressources': <img alt="" src={panenkaImg} width="100%" /> },
    'boursonomic': { 'title': 'Boursonomic (Work in Progress)', 'date': '16/04/2020', 'categories': ['front', 'back', 'data', 'ops'], 'presentation': <p className="text-justify" style={{ "paddingTop": "3%" }}>Création et développement d'une plateforme en ligne pour un groupe d'amis souhaitant suivre l'évolution de leur portefeuille bousier.</p>, 'technos': ['React', 'Python 3', 'Flask', 'Docker', 'InfluxDB', 'PostgreSQL', 'MongoDB', 'Airflow', 'GitLab'], 'addButon': false, 'addressources': true, 'ressources': <img alt="" src={boursonomicImg} width="100%" /> },
